...
# 測試資料庫設定 - 使用 PostgreSQL 測試資料庫
import os
from app.core.config import settings

# 使用測試資料庫 URL 或預設的 PostgreSQL
TEST_DATABASE_URL = os.getenv("TEST_DATABASE_URL", "postgresql://postgres:password@localhost:5432/tw_zapier_test")
